...
public class simpleShape
{
     ...
     */
    public void addTriangle( float x0, float y0, float z0,
    ...
    public void addTriangleT( float x0, float y0, float z0, float u0, float v0,
    ...
    public void addTriangleNT(float x0, float y0, float z0, float u0, float v0,
            float x1, float y1, float z1,  float u1, float v1,
            float x2, float y2, float z2, float u2, float v2,
            float nx0, float ny0, float nz0, 
            float nx1, float ny1, float nz1,
